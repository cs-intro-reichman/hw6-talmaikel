...
public class Runigram {
	...
	public static void main(String[] args) {
		...
		if(blendTest.equals("blend")){
			...
			Color[][] blended =blend(image1, image2, alpha);
	...
	public static Color blend(Color c1, Color c2, double alpha) {
		// collect RBG info of c1.
		double r1 = c1.getRed();
		double g1 = c1.getGreen();
		double b1 = c1.getBlue();
		// collect RBG info of c2.
		double r2 = c2.getRed();
	...
	public static void morph(Color[][] source, Color[][] target, int n) {
		...
		Color[][] morphPic = new Color[source.length][source[0].length];
		double dN = n;
		
		for (double i = 0; i <= n; i++) {
			morphPic = blend(source, scaledTarget, (dN - i) / dN);
			Runigram.setCanvas(morphPic);
			Runigram.display(morphPic);
			StdDraw.pause(500);
		}
	}
